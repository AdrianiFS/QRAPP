...
<head>
    ...
    <title>{{ config('app.name', 'Pro QR Solutions') }}</title>
        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{ URL::asset('images/qr1.png') }}" alt="Qr code solutions" class="qrBranding">
                </a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="{{ url('/qrpages/qrform') }}">My Dashboard</a>
                        </li>
                        @guest
                        @if (Route::has('login'))
                        <li class="nav-item">
